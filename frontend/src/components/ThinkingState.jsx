  ...
  return (
    <div
      ...
      style={{
        ...
        background: 'linear-gradient(to top, #ff914d, #ec4899)',
      }}
    />
  )
}
  ...
  return (
    <div className="bg-transparent rounded-xl p-8 my-8 text-white min-h-96 flex flex-col items-center justify-center shadow-none border border-transparent overflow-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#ff914d]/5 rounded-full blur-3xl pulse-glow" />
      ...
      {/* Title */}
      <h2 className="text-3xl font-bold mb-2 relative z-10 bg-linear-to-r from-[#ff914d] to-pink-500 bg-clip-text text-transparent">
              ...
              <div key={step.id} className="flex items-center">
                ...
                {idx > 0 && (
                  <div className="h-0.5 flex-1 relative">
                    ...
                    <div
                      className="absolute inset-y-0 left-0 bg-linear-to-r from-[#ff914d] to-pink-500 rounded-full transition-all duration-700 ease-out"
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm shrink-0 transition-all duration-500 ${
                    isCompleted
                      ? 'bg-linear-to-br from-[#ff914d] to-pink-500 text-white shadow-lg shadow-[#ff914d]/30'
                      : isActive
                      ? 'border-2 border-[#ff914d] text-[#ff914d] step-pulse scale-110'
            ...
            return (
              <div key={`label-${step.id}`} className="flex flex-col items-center mt-3 text-center">
                <span className={`text-sm font-semibold transition-colors duration-300 ${
                  isActive ? 'text-[#ff914d]' : isCompleted ? 'text-gray-300' : 'text-gray-600'
                }`}>
                  {step.label}
                </span>
