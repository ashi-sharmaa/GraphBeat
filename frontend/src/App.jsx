    ...
    <div className="min-h-screen w-full bg-gray-950">
      ...
      <header className="w-full pt-16 pb-10">
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xl text-gray-400 tracking-wider font-light">Discover the <span className="bg-linear-to-r from-orange-400 to-pink-500 bg-clip-text text-transparent font-medium">genetic bridge</span> between your favorite songs!</p>
        </div>
      </header>
